Vagrant.configure("2") do |config|
  ...
  config.vm.define :mongoa do |mongo1|
    ...
    config.vm.synced_folder "config/a", "/home/ubuntu/config"
  ...
  config.vm.define :mongob do |mongo2|
    ...
    config.vm.synced_folder "config/b", "/home/ubuntu/config"
  ...
  config.vm.define :mongoc do |mongo3|
    ...
    config.vm.synced_folder "config/c", "/home/ubuntu/config"
